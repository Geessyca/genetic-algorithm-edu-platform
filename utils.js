...
document.addEventListener("DOMContentLoaded", function () {
    salvarNoLocalStorage("Taxa_Mutacao", 50);
    salvarNoLocalStorage("Taxa_Precisao", 80);
    salvarNoLocalStorage("Populacao_Inicial", 10);
    salvarNoLocalStorage("Selecao", "roleta");
    salvarNoLocalStorage("Criterio_Parada", "random");
    let generationLabel = document.getElementById("generation_current");
    ...
    let statisticContainer = document.getElementById("statistic-container");
    let stepContainer = document.getElementById("step-container");
